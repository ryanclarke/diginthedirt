...
var _ryanclarke$diginthedirt$Model$Model = F6(
	function (a, b, c, d, e, f) {
		return {text: a, tries: b, tickDuration: c, lastTickDuration: d, lastTimestamp: e, actions: f};
	});
...
var _ryanclarke$diginthedirt$Update$dig = function (model) {
	var actions = A2(
		_elm_lang$core$List$map,
		function (x) {
			var _p0 = x.act;
		...
		model.actions);
	var tries = model.tries + 1;
	var text = _elm_lang$core$Basics$toString(tries);
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Native_Utils.update(
			model,
			{text: text, tries: tries, actions: actions}),
	...
	function (msg, model) {
		...
		if (_p2.ctor === 'Tick') {
			...
			switch (_p3.ctor) {
				...
				case 'Dig':
					return _ryanclarke$diginthedirt$Update$dig(model);
				default:
					return _ryanclarke$diginthedirt$Update$dig(model);
			}
		}
...
if (typeof _ryanclarke$diginthedirt$Update$main !== 'undefined') {
    _ryanclarke$diginthedirt$Update$main(Elm['Update'], 'Update', undefined);
}
