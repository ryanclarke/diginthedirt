...
var _ryanclarke$diginthedirt$Model$Model = function (a) {
	return {text: a};
};
...
var _ryanclarke$diginthedirt$Update$gameTick = function (model) {
	return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
};
var _ryanclarke$diginthedirt$Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return _ryanclarke$diginthedirt$Update$gameTick(model);
	});
