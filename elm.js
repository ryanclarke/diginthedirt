...
var _ryanclarke$diginthedirt$GameTick$gameTick = F2(
	function (model, time) {
		...
		var processedActions = A2(
			_elm_lang$core$List$map,
			function (x) {
				return _elm_lang$core$Native_Utils.eq(x.progress, _ryanclarke$diginthedirt$Model$Finished) ? _elm_lang$core$Native_Utils.update(
					x,
...
var _ryanclarke$diginthedirt$View$btn = function (action) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(isDisabled.action),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$type_('button'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('rounded-full p-2 m-2 w-32 border-solid border border-black'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(
							{
								...
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'background-image', _1: 'linear-gradient(lightgray 0, lightgray 100%)'},
									_1: {
										ctor: '::',
										...
										_1: {
											...
											_0: {
												ctor: '_Tuple2',
												_0: 'background-size',
												_1: A2(_elm_lang$core$Basics_ops['++'], pct, '% 100%')
											},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'cursor', _1: isDisabled.cursor},
												_1: {ctor: '[]'}
											}
										}
									}
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('border-solid border-2 border-green-dark border-t-0'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _ryanclarke$diginthedirt$View$mainView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _ryanclarke$diginthedirt$View$headerView = A2(
	_elm_lang$html$Html$header,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('bg-green-dark p-4 text-justify w-full'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('text-white inline pr-4'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Dig in the Dirt'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('a simple game written in '),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$href('https://www.ryanclarke.net'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Ryan Clarke'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$href('https://github.com/ryanclarke/diginthedirt'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
...
var _ryanclarke$diginthedirt$View$view = function (model) {
	var css = A3(
		...
		'link',
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$href('https://cdn.jsdelivr.net/npm/tailwindcss/dist/tailwind.min.css'),
				_1: {ctor: '[]'}
			}
		},
		{ctor: '[]'});
	var wrapper = function (body) {
		return A2(
			...
			},
			{
				...
				_1: {
					ctor: '::',
					_0: _ryanclarke$diginthedirt$View$headerView,
					_1: {
						ctor: '::',
						_0: body,
						_1: {ctor: '[]'}
